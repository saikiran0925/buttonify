...
jsonFormatButton.addEventListener("click", () => {
    generateButtonsFromJSON(jsonTextField.value,jsonInputField1.value, jsonInputField2.value, jsonInputField3.value, jsonInputField4.value, jsonInputField5.value);
});
